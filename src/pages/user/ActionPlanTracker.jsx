...
const ActionPlanTracker = () => {
    ...
    return (
        <div className="overflow-x-hidden h-screen flex min-w-0 flex-col p-[16px_24px] gap-4 bg-[#FCFCFC]">
            <div className=" flex  flex min-w-0 gap-[12px] border border-[#E4E4E4] rounded-[12px] p-[12px] bg-[#FFFFFF] shadow-[0px_10px_16px_0px_#0000000A]">
                <div className="flex min-w-0 items-center justify-center gap-[10px] w-[44px] rounded-lg border border-gray-300 bg-[#FFCCC5]">
                ...
                <div className=" justify-center  flex min-w-0 flex-col gap-[4px]">
                    <p className=" justify-center font-inter font-medium text-[18px] leading-[24px] text-[#212121] tracking-[-0.005em]">
                        Action Plan Tracker
                    </p>
                    <p className=" font-inter font-normal text-[12px] leading-[16px] tracking-[0em]  flex min-w-0 text-[#84838A] items-center">
                        Lorem Ipsum
                    </p>

                </div>
            </div>
            <div className=" flex min-w-0 flex-col gap-[32px] border border-[#E4E4E4] bg-[#FFFFFF] rounded-[12px] p-[16px] shadow-[0px_10px_16px_0px_#0000000A]">
                <div className=" flex min-w-0 flex-col gap-[12px]">
                    ...
                    <div className="flex min-w-0 justify-between ">
                        <div className="w-full max-w-[596px]  flex gap-3">
                            <Dropdown
                        ...
                        <div className="flex-1 min-w-0 flex justify-end">
                            <div className=" w-full max-w-[140px] min-w-0 flex gap-[8px] border border-[#F1F1F1] rounded-[8px] p-[12px_10px] items-center">
                ...
                <div className="border border-[#E4E4E4] rounded-[12px] overflow-x-auto overflow-hidden">
                    <table className="w-full h-full border-collapse border border-[#E4E4E4] text-[12px] text-[#212121]">
                        <thead className=" bg-[#F6F6F6] font-inter text-[12px] font-normal text-[#212121] leading-[150%] tracking-[-0.5%]">
                            <tr>
                                ...
                                {[...Array(6)].map((_, i) => (
                                    <th key={i} className="p-[12px] font-inter gap-[8px] text-center border-y border-[#E4E4E4]">
                                        <div className="flex min-w-0 justify-center gap-[8px] items-center min-w-fit ">
                            ...
                            {data.map((row, index) => {
                                ...
                                return (
                                    <React.Fragment key={index}>
                                        ...
                                        >
                                            <td className="">
                                                <div className="flex min-w-[540px] p-[12px] gap-[8px]">
                                                    <div>
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex min-w-0 rounded-lg justify-between">
                    ...
                    <div className="flex min-w-0 flex-1 gap-[8px] justify-end">
                        <p className="items-center justify-center p-[5px]">Showing 1 to 10 of 1253 Center</p>
                        <button className="w-[64px] h-[32px]c flex  min-w-0 gap-[8px] border border-[#F1F1F1] p-[5px] rounded-lg"><label>10</label><svg width="20" className="items-center flex justify-center" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">

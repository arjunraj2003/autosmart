...
const DropDownR = () => {
    return (
        <div className="w-full  flex gap-[8px] rounded-[8px] border border-[#E4E4E4] p-[8px] bg-[#FFFFFF] font-inter font-normal leading-[12px] tracking-[-0.5px] align-bottom">
            <div className="w-full h-full  gap-[4px] rounded-[4px] flex flex-col  ">
                <div className="w-full h-[16px] text-[12px] font-inter text-[#212121] leading-[18px] font-medium">2024 Jan - 2024 Dec</div>
                <div className="w-full h-[16px] flex gap-[8px]">
